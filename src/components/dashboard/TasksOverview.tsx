      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-2 text-sm">
          ...
          <button
            ...
            className={`px-3 py-1 rounded-md ${
              filter === "todo" ? "bg-gray-100 font-medium" : "hover:bg-gray-50"
            }`}
          >
            To Do
          </button>
...
function TaskItem({ task }: { task: Task }) {
  ...
  return (
    <Link
      href={`/tasks/${task.id}`}
      className="block border border-gray-100 rounded-md p-3 hover:bg-gray-50 hover:border-blue-300 transition-colors"
    >
