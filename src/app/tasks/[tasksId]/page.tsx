...
export default function TaskDetailPage() {
 ...
 const [project, setProject] = useState<typeof projectsData.projects[0] | null>(null);
           ...
           <div className="bg-gray-50 rounded-lg p-4">
             {assignee ? (
               <div>
                 ...
                 <div className="text-sm">
                   ...
                   <div className="flex items-center">
                     ...
                     <a href={`mailto:${assignee.email}`} className="text-blue-600 hover:text-blue-800">
                       {assignee.email}
                     </a>
                   </div>
                 </div>
               ...
               <div className="text-center py-4">
                 <p className="text-gray-500 mb-2">This task is not assigned to anyone</p>
